---
title: "Housing_Week4_TatreauGillian"
...
## f. Created bathrooms (combined half and quarter bathrooms to read as 1.5 baths instead of two variables), Sale_Year (the year houses were sold), sq_ft_outside (the square footage of outside space). Code is include in section: Set up for reading the file. 
