...
## Use `setwd()` if needed
# setwd("/Users/gillian/Documents/Bellevue Grad Program/Fall2022/DSC520/DSC520 Repo")
...
voter_turnout_df2 <- read_excel("data/G04ResultsDetail2004-11-02.xls", 
                                sheet = "Voter Turnout", skip = 2, col_names = c("ward-precint", "ballots_cast", "registered_voters", "voter_turnout"))
